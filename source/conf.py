...
project = 'TARTRL'
copyright = '2023, TARTRL Contributors'
...
html_theme_options = {
    'logo_url':
    'https://hsy-test-docs.readthedocs.io/{}/latest/'.format(rtd_lang),
    'menu': [
        {
            'name': 'GitHub',
...
latex_documents = [
    (master_doc, 'TARTRL.tex', 'TARTRL Documentation', 'bao', 'manual'),
]
...
man_pages = [(master_doc, 'TARTRL', 'TARTRL Documentation', [author], 1)]
...
texinfo_documents = [
    (master_doc, 'TARTRL', 'TARTRL Documentation', author, 'TARTRL',
